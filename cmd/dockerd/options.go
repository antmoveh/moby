...
func (o *daemonOptions) installFlags(flags *pflag.FlagSet) {
	...
	flags.BoolVar(&o.GCHcs, "gc-hcs", false, "Use HCS garbage collector")
	flags.BoolVar(&o.GCForce, "gc-force", false, "Use HCS garbage collector")
	flags.IntVar(&o.GCForceTime, "gc-force-time", 3, "more than three minutes to force gc")
